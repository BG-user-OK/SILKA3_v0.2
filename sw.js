...
const CACHE_NAME = 'silka3-vGPT_1.6.1';
const CORE_ASSETS = [
  './',
  './index.html',
  './styles.css',
  ...
  './Photos/Bateria.png',
  './Photos/8.jpg?v=vGPT_1.6.1',
  './Photos/11.jpg?v=vGPT_1.6.1',
  './Photos/14.jpg?v=vGPT_1.6.1',
  './Photos/16.jpg?v=vGPT_1.6.1',
  './Photos/17.jpg?v=vGPT_1.6.1',
  './Photos/18.jpg?v=vGPT_1.6.1',
